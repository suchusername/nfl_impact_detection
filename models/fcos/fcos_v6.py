...
def build_model(**kwargs):
    ...
    # x = tf.keras.layers.DepthwiseConv2D((3,3), padding='same', use_bias='False')(img_input)
    # x = tf.keras.layers.Conv2D(16, kernel_size=(1,1), padding='same', use_bias='False', strides=(1,1))(x)
    ...
    x = tf.keras.layers.Conv2D(32, kernel_size=(1,1), padding='same', use_bias='False', strides=(1,1))(x)
    x = tf.keras.layers.Dropout(kwargs["dropout"])(x)
    ...
    x = tf.keras.layers.DepthwiseConv2D((3,3), padding='same', use_bias='False')(x)
    x = tf.keras.layers.Conv2D(64, kernel_size=(1,1), padding='same', use_bias='False', strides=(1,1))(x)  
    x = tf.keras.layers.Dropout(kwargs["dropout"])(x)
    ...
    # x = tf.keras.layers.DepthwiseConv2D((3,3), padding='same', use_bias='False')(x)
    # x = tf.keras.layers.Conv2D(64, kernel_size=(1,1), padding='same', use_bias='False', strides=(1,1))(x)
    # feature_map = tf.keras.layers.Dropout(kwargs["dropout"])(x)
